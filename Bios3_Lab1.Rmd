...
To run code within the RMarkdown file, you can use the shortcut `Ctrl + Alt + C` within the current chunk where the cursor is positioned. You can also select `Code` > `Run region` > `Run current chunk` from the RStudio menu.
